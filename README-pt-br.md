<!-- |||||||||||||||||||| EN - PT |||||||||||||||||||| -->
<p align='center'>
  <a href="https://github.com/dev-ggomes/professional-landing-page-2/blob/main/README.md">🇺🇸 English</a> | 
  <a href="https://github.com/dev-ggomes/professional-landing-page-2/blob/main/README-pt-pt.md">ᴘᴛ Português</a> | 
  <a href="https://github.com/dev-ggomes/professional-landing-page-2/blob/main/README-pt-br.md">🇧🇷 Português</a>
</p>

<h1 align="center">🚀 Guilherme Gomes - Portfólio de Desenvolvedor</h1>
...
<p align='center'>
  💻 Uma versão melhorada da minha  
  <a href="https://github.com/dev-ggomes/professional-landing-page">antiga landing page</a>
</p>

<p align="center">
  ⭐ Se gostar deste projeto, por favor contribua com uma estrelinha
</p>
...
Sou um desenvolvedor português de 19 anos, apaixonado por desenvolver soluções impactantes desde 2020.

- 💻 Desenvolvedor Full Stack  
- 🎮 Desenvolvedor de Jogos na Web 
...
Ferramenta CLI em Python para automações no Instagram  
👉 [Link](https://github.com/dev-ggomes/auto-unfollow-and-remove-follower4-instagram)

### 🔹 Auto Refresh Any Site
Ferramenta de automação em C# para simular comportamento humano  
...
### 🔹 BookHub
Sistema de administração bibliotecária (PHP + MySQL)  
👉 [Link](https://github.com/dev-ggomes/bookhub)

### 🔹 Weather Dashboard
Aplicativo de clima em tempo real 
...
- 🎨 UI/UX moderno
- ⚡ Animações suaves  
- 📊 Integração de estatísticas do Github 
- 📩 Formulário de contacto via Email  
